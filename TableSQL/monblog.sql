...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  ven. 14 sep. 2018 à 11:52
...
CREATE TABLE IF NOT EXISTS `auteur` (
  ...
  `auteur_photo` varchar(100) NOT NULL,
  `auteur_texte` text NOT NULL,
  `auteur_titre` varchar(100) NOT NULL
...
INSERT INTO `auteur` (`auteur_id`, `auteur_photo`, `auteur_texte`, `auteur_titre`) VALUES
...
INSERT INTO `commentaire` (`com_id`, `com_date`, `com_auteur`, `com_contenu`, `bil_id`, `signal_count`, `is_read`) VALUES
(35, '2018-08-27 13:39:44', 'Pierre', 'J\'aime beaucoup ce chapitre ! Wow', 1, 0, 0),
(36, '2018-08-27 13:40:00', 'Olivier', 'Quel 1er chapitre ! Vivement la suite !', 1, 0, 0),
(37, '2018-08-27 13:40:24', 'Claire', 'L\'histoire est bien ficelée, j\'aime !', 1, 0, 0),
(38, '2018-08-27 13:40:45', 'Yu', 'Encore un chapitre digne de se nom !', 2, 0, 0),
(39, '2018-08-27 13:41:13', 'jean', 'Humm, décevant ce chapitre, je m\'attendais à mieux.', 2, 0, 0),
(40, '2018-08-27 13:43:47', 'Kosaki', 'Waow, L\'amour triomphera !', 3, 0, 1);
...
INSERT INTO `utilisateur` (`util_id`, `util_login`, `util_mdp`) VALUES
(1, 'JeanForteroche', '1aF89wXo98eBn#24i');
...
ALTER TABLE `commentaire`
  ADD CONSTRAINT `fk_com_bil` FOREIGN KEY (`bil_id`) REFERENCES `billet` (`bil_id`) ON DELETE CASCADE;
COMMIT;
