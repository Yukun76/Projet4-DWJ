...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  lun. 27 août 2018 à 13:44
...
INSERT INTO `t_auteur` (`auteur_id`, `auteur_photo`, `auteur_texte`, `auteur_titre`) VALUES
...
INSERT INTO `t_billet` (`bil_id`, `bil_date`, `bil_titre`, `bil_num`, `bil_contenu`) VALUES
...
CREATE TABLE IF NOT EXISTS `t_commentaire` (
  ...
  KEY `BIL_ID` (`bil_id`),
  KEY `bil_titre` (`bil_titre`) USING BTREE
...
INSERT INTO `t_commentaire` (`com_id`, `com_date`, `com_auteur`, `com_contenu`, `bil_id`, `signal_count`, `bil_titre`) VALUES
(35, '2018-08-27 13:39:44', 'Pierre', 'J\'aime beaucoup ce chapitre ! Wow', 1, 0, ''),
(36, '2018-08-27 13:40:00', 'Olivier', 'Quel 1er chapitre ! Vivement la suite !', 1, 0, ''),
(37, '2018-08-27 13:40:24', 'Claire', 'L\'histoire est bien ficelée, j\'aime !', 1, 0, ''),
(38, '2018-08-27 13:40:45', 'Yu', 'Encore un chapitre digne de se nom !', 2, 0, ''),
(39, '2018-08-27 13:41:13', 'jean', 'Humm, décevant ce chapitre, je m\'attendais à mieux.', 2, 0, ''),
(40, '2018-08-27 13:43:47', 'Kosaki', 'Waow, L\'amour triomphera !', 3, 0, '');
